...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="pull-left">Programacaos: Edit</h1>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($programacao, ['route' => ['programacaos.update', $programacao->id], 'method' => 'patch']) !!}

            @form_maker_object($programacao, FormMaker::getTableColumns('programacaos'))
